...
class MultipleChoice extends QuestionType {
  ...
  factory MultipleChoice.fromJson(
    ...
    return MultipleChoice(
      ...
      plus: Color.from(
        alpha: (json['plus']['a'] as num).toDouble(),
        red: (json['plus']['r'] as num).toDouble(),
        green: (json['plus']['g'] as num).toDouble(),
        blue: (json['plus']['b'] as num).toDouble(),
      ),
      minus: Color.from(
        alpha: (json['minus']['a'] as num).toDouble(),
        red: (json['minus']['r'] as num).toDouble(),
        green: (json['minus']['g'] as num).toDouble(),
        blue: (json['minus']['b'] as num).toDouble(),
      ),
      ...
      numberColor: Color.from(
        alpha: (json['numberColor']['a'] as num).toDouble(),
        red: (json['numberColor']['r'] as num).toDouble(),
        green: (json['numberColor']['g'] as num).toDouble(),
        blue: (json['numberColor']['b'] as num).toDouble(),
      ),
      iconColor: Color.from(
        alpha: (json['iconColor']['a'] as num).toDouble(),
        red: (json['iconColor']['r'] as num).toDouble(),
        green: (json['iconColor']['g'] as num).toDouble(),
        blue: (json['iconColor']['b'] as num).toDouble(),
      ),
