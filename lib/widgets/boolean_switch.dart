  ...
  factory BooleanSwitch.fromJson(
    ...
    return BooleanSwitch(
      ...
      selectedColor: Color.from(
        alpha: (json['selectedColor']['a'] as num).toDouble(),
        red: (json['selectedColor']['r'] as num).toDouble(),
        green: (json['selectedColor']['g'] as num).toDouble(),
        blue: (json['selectedColor']['b'] as num).toDouble(),
      ),
